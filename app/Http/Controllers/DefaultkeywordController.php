...
class DefaultkeywordController extends Controller
{
    ...
    public function index(DefaultKeywordDataTable $dataTable)
    {
        ...
        $button = $auth_user->can('defaultkeyword-add') ? '<a href="'.route('defaultkeyword.create').'" class="btn btn-sm btn-primary loadRemoteModel"><i class="fa fa-plus-circle"></i> '.__('message.add_form_title',['form' => __('message.keyword')]).'</a>' : '';

    ...
    <div class="col-lg-6">
        ...
        <div class="form-group col-md-12">
            ...
            <div class="input-group">
                {!! html()->input('color', 'bg_color', $settings->color ?? '#FE6F07')->class('form-control form-control-color')->id('bg_color_picker')->attribute('title', __('message.theme_color'))->required()!!}
                {!! html()->text('color', $settings->color ?? '#FE6F07')->placeholder(__('message.bg_color'))->class('form-control')->id('bg_color_code')->required()!!}
            </div>
        </div>

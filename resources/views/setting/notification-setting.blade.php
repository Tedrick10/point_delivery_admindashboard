                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <div class="custom-switch custom-switch-color custom-control-inline">
                                    {!! html()->hidden('notification_settings[global][IS_PUSH_NOTIFICATION_ENABLED]', 0) !!}
                                    {!! html()->checkbox('notification_settings[global][IS_PUSH_NOTIFICATION_ENABLED]', isset($notification_setting_data['global']['IS_PUSH_NOTIFICATION_ENABLED']) ? $notification_setting_data['global']['IS_PUSH_NOTIFICATION_ENABLED'] : 1, 1)
                                        ->class('custom-control-input')
                                        ->id('global_push_enabled') !!}
                                    {!! html()->label(__('message.enable_push_notifications'), 'global_push_enabled')->class('custom-control-label font-weight-bold') !!}
                                </div>
                                <p class="text-muted small mb-0">{{ __('message.enable_push_notifications_help') }}</p>
                            </div>
                        </div>
                        <div class="row">

...
<head>
    ...
    <style>
        ...
        .kpay-section { margin-top: 24px; page-break-before: auto; }
        .kpay-section h3 { font-size: 12px; margin-bottom: 8px; }
        .kpay-section img { max-width: 100%; max-height: 700px; }
    </style>
</head>
<body>
    <div class="header">

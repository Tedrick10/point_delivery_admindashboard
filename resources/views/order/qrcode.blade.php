        ...
        <table>
            <tr>
                <td style="width: 60%; vertical-align: top;">
                    <div class="mb-2">
                        <p style="margin: 0; text-align: center;"><strong>{{ optional($companyName)->value ?? config('app.name') }}</strong></p>
                        <p style="margin: 0; text-align: center;">{{ optional($companynumber)->value ?? '' }}</p>
                    </div>
                </td>
            </tr>
            <tr>

<div class="pds-report-toolbar">
    {!! html()->form('GET', route('report-deliverymanEarning'))->id('filter-form')->class('pds-report-toolbar__form')->open() !!}
        ...
        <div class="pds-report-toolbar__actions">
            ...
            <a href="{{ route('report-deliverymanEarning') }}" class="btn btn-sm btn-outline-primary">
...
@include('report.deliverymanexportmodel')

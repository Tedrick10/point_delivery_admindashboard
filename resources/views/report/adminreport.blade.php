                            ...
                            <table id="basic-table" class="table w-100 pds-datatable pds-report-table text-center mb-0" role="grid">
                                ...
                                <tfoot>
                                    <tr class="pds-report-total-row">
                                        ...
                                        <td class="font-weight-bold">{{ getPriceFormat($totaldeliverymanAmountSum) }}</td>
                                        <td></td>
                                    </tr>
                                </tfoot>
                            </table>
            ...
            $(document).ready(function() {
                ...
                $('#filter-form').validate({
                    rules: {
                        ...
                        to_date: { greaterThanEqual: '#from_date_main' }
                    },
                    messages: {
                        from_date: { required: "{{ __('message.from_date_required') }}" },
                        to_date: { greaterThanEqual: "{{ __('message.to_date_must_be_greater_than_from_date') }}" }
                    },

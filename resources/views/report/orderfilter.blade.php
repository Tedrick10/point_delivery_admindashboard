<div class="pds-report-toolbar">
    {!! html()->form('GET', route('order-of-report'))->id('filter-form')->class('pds-report-toolbar__form')->open() !!}
        ...
        <div class="pds-report-toolbar__actions">
            ...
            <a href="{{ route('order-of-report') }}" class="btn btn-sm btn-outline-primary">
...
@include('report.orderreportexportmodel')
